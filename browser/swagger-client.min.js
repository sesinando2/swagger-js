...
(function (process){
"use strict";var _={isPlainObject:require("lodash-compat/lang/isPlainObject"),indexOf:require("lodash-compat/array/indexOf")};module.exports.__bind=function(e,n){return function(){return e.apply(n,arguments)}};var log=module.exports.log=function(){console&&"test"!==process.env.NODE_ENV&&console.log(Array.prototype.slice.call(arguments)[0])};module.exports.fail=function(e){log(e)},module.exports.optionHtml=function(e,n){return'<tr><td class="optionName">'+e+":</td><td>"+n+"</td></tr>"};var resolveSchema=module.exports.resolveSchema=function(e){return _.isPlainObject(e.schema)&&(e=resolveSchema(e.schema)),e};module.exports.simpleRef=function(e){if(void 0===e)return null;var n=e.indexOf("#/definitions/");return n>=0?e.substring(n+"#/definitions/".length):e},module.exports.extractExtensions=function(e,n,o){e&&n&&"string"==typeof e&&0===e.indexOf("x-")&&(n.vendorExtensions=n.vendorExtensions||{},n.vendorExtensions[e]=o||n[e])};
...
"use strict";var Helpers=require("./helpers"),_={isPlainObject:require("lodash-compat/lang/isPlainObject"),isUndefined:require("lodash-compat/lang/isUndefined"),isArray:require("lodash-compat/lang/isArray"),isObject:require("lodash-compat/lang/isObject"),isEmpty:require("lodash-compat/lang/isEmpty"),map:require("lodash-compat/collection/map"),indexOf:require("lodash-compat/array/indexOf"),cloneDeep:require("lodash-compat/lang/cloneDeep"),keys:require("lodash-compat/object/keys"),forEach:require("lodash-compat/collection/forEach")},optionHtml=module.exports.optionHtml=function(e,t){return'<tr><td class="optionName">'+e+":</td><td>"+t+"</td></tr>"};module.exports.typeFromJsonSchema=function(e,t){var i;return"integer"===e&&"int32"===t?i="integer":"integer"===e&&"int64"===t?i="long":"integer"===e&&void 0===t?i="long":"string"===e&&"date-time"===t?i="date-time":"string"===e&&"date"===t?i="date":"number"===e&&"float"===t?i="float":"number"===e&&"double"===t?i="double":"number"===e&&void 0===t?i="double":"boolean"===e?i="boolean":"string"===e&&(i="string"),i};var getStringSignature=module.exports.getStringSignature=function(e,t){var i="";return void 0!==e.$ref?i+=Helpers.simpleRef(e.$ref):void 0===e.type?i+="object":"array"===e.type?t?i+=getStringSignature(e.items||e.$ref||{}):(i+="Array[",i+=getStringSignature(e.items||e.$ref||{}),i+="]"):"integer"===e.type&&"int32"===e.format?i+="integer":"integer"===e.type&&"int64"===e.format?i+="long":"integer"===e.type&&void 0===e.format?i+="long":"string"===e.type&&"date-time"===e.format?i+="date-time":"string"===e.type&&"date"===e.format?i+="date":"string"===e.type&&void 0===e.format?i+="string":"number"===e.type&&"float"===e.format?i+="float":"number"===e.type&&"double"===e.format?i+="double":"number"===e.type&&void 0===e.format?i+="double":"boolean"===e.type?i+="boolean":e.$ref?i+=Helpers.simpleRef(e.$ref):i+=e.type,i},schemaToJSON=module.exports.schemaToJSON=function(e,t,i,n){e=Helpers.resolveSchema(e),"function"!=typeof n&&(n=function(e){return(e||{}).default}),i=i||{};var r,o,s=e.type||"object",a=e.format;return _.isUndefined(e.example)?_.isUndefined(e.items)&&_.isArray(e.enum)&&(o=e.enum[0]):o=e.example,_.isUndefined(o)&&(e.$ref?(r=t[Helpers.simpleRef(e.$ref)],_.isUndefined(r)||(_.isUndefined(i[r.name])?(i[r.name]=r,o=schemaToJSON(r.definition,t,i,n),delete i[r.name]):o="array"===r.type?[]:{})):_.isUndefined(e.default)?"string"===s?o="date-time"===a?(new Date).toISOString():"date"===a?(new Date).toISOString().split("T")[0]:"string":"integer"===s?o=0:"number"===s?o=0:"boolean"===s?o=!0:"object"===s?(o={},_.forEach(e.properties,function(r,s){var a=_.cloneDeep(r);a.default=n(r);var p=function(e){if(!_.isUndefined(e.example))return!0;if(e.$ref){var i=t[Helpers.simpleRef(e.$ref)];i&&i.definition&&(e=i.definition)}if("object"===e.type){for(var n in e.properties){var r=e.properties[n];if(p(r))return!0}return!1}},l=e.required&&e.required.indexOf(s)>=0;(p(r)||l)&&(o[s]=schemaToJSON(a,t,i,n))})):"array"===s&&(o=[],_.isArray(e.items)?_.forEach(e.items,function(e){o.push(schemaToJSON(e,t,i,n))}):_.isPlainObject(e.items)?o.push(schemaToJSON(e.items,t,i,n)):_.isUndefined(e.items)?o.push({}):Helpers.log("Array type's 'items' property is not an array or an object, cannot process")):o=e.default),o};module.exports.schemaToHTML=function(e,t,i,n){function r(e,t,n){var r,o=t;return e.$ref?(o=e.title||Helpers.simpleRef(e.$ref),null!==(r=i[o])&&null!==r.definition.title&&void 0!==r.definition.title&&(o=r.definition.title)):_.isUndefined(t)&&(o=e.title||"Inline Model "+ ++m,r={definition:e}),!0!==n&&(p[o]=_.isUndefined(r)?{}:r.definition),o}function o(e){var t,i='<span class="propType"',n=e.type||"object";return e.$ref?(t=r(e,Helpers.simpleRef(e.$ref)),i+=" title="+t+">"+t):"object"===n?_.isUndefined(e.properties)?i+=' title="object">object':(t=r(e),i+=" title="+t+">"+t):"array"===n?(i+="Array[",_.isArray(e.items)?t=_.map(e.items,r).join(","):_.isPlainObject(e.items)?t=_.isUndefined(e.items.$ref)?_.isUndefined(e.items.type)||-1!==_.indexOf(["array","object"],e.items.type)?r(e.items):e.items.type:r(e.items,Helpers.simpleRef(e.items.$ref)):(Helpers.log("Array type's 'items' schema is not an array or an object, cannot process"),t+="object"),i+=" title=array["+t+"]>array["+t+"]"):i+=" title="+e.type+">"+e.type,i+="</span>"}function s(e,t){var i="",n=e.type||"object",r="array"===n;switch(r&&(n=_.isPlainObject(e.items)&&!_.isUndefined(e.items.type)?e.items.type:"object"),_.isUndefined(e.default)||(i+=optionHtml("Default",e.default)),n){case"string":e.minLength&&(i+=optionHtml("Min. Length",e.minLength)),e.maxLength&&(i+=optionHtml("Max. Length",e.maxLength)),e.pattern&&(i+=optionHtml("Reg. Exp.",e.pattern));break;case"integer":case"number":e.minimum&&(i+=optionHtml("Min. Value",e.minimum)),e.exclusiveMinimum&&(i+=optionHtml("Exclusive Min.","true")),e.maximum&&(i+=optionHtml("Max. Value",e.maximum)),e.exclusiveMaximum&&(i+=optionHtml("Exclusive Max.","true")),e.multipleOf&&(i+=optionHtml("Multiple Of",e.multipleOf))}if(r&&(e.minItems&&(i+=optionHtml("Min. Items",e.minItems)),e.maxItems&&(i+=optionHtml("Max. Items",e.maxItems)),e.uniqueItems&&(i+=optionHtml("Unique Items","true")),e.collectionFormat&&(i+=optionHtml("Coll. Format",e.collectionFormat))),_.isUndefined(e.items)&&_.isArray(e.enum)){var o;o="number"===n||"integer"===n?e.enum.join(", "):'"'+e.enum.join('", "')+'"',i+=optionHtml("Enum",o)}return t}function a(e,t){var a=e.type||"object",p="array"===e.type,m='<span class="strong objectName"><span class="bracketsIcon">'+(p?"[]":"{}")+'</span> <span class="objectNameText">',d="";if("Inline Model"!==t&&(d=_.isUndefined(e.title)?m+t+"</span></span>":m+e.title+"</span></span>"),t&&l.push(t),p)if(_.isArray(e.items))d+="<div>"+_.map(e.items,function(e){var t=e.type||"object";return _.isUndefined(e.$ref)?_.indexOf(["array","object"],t)>-1?"object"===t&&_.isUndefined(e.properties)?"object":r(e):s(e,t):r(e,Helpers.simpleRef(e.$ref))}).join("</div><div>");else if(_.isPlainObject(e.items)){var f="";f=_.isUndefined(e.items.$ref)?_.indexOf(["array","object"],e.items.type||"object")>-1?(_.isUndefined(e.items.type)||"object"===e.items.type)&&_.isUndefined(e.items.properties)?"object":r(e.items):s(e.items,e.items.type):r(e.items,Helpers.simpleRef(e.items.$ref)),"Inline Model"!==t&&(d+="<div>"+f+"</div>")}else Helpers.log("Array type's 'items' property is not an array or an object, cannot process"),d+="<div>object</div>";else e.$ref?d+="<div>"+r(e,t)+"</div>":"object"===a?(d+="<div>",_.isPlainObject(e.properties)&&(d+=_.map(e.properties,function(t,r){var a,p=_.indexOf(e.required,r)>=0,l=_.cloneDeep(t),m='<span class="propLabels">';return m+='<span class="propName propOpt">'+r+"</span>",l.default=n(l),l=Helpers.resolveSchema(l),_.isUndefined(l.$ref)||(a=i[Helpers.simpleRef(l.$ref)],_.isUndefined(a)||-1!==_.indexOf([void 0,"array","object"],a.definition.type)||(l=Helpers.resolveSchema(a.definition))),m+=o(l),p||(m+='<span class="propOptKey">(optional)</span>'),m+="</span>",m+='<span class="propDesc">',_.isUndefined(t.description)||(m+=t.description),l.enum&&(m+='<div class="propVals">Can be ',_.forEach(l.enum,function(e,t){m+="<code>"+e+"</code>",t===l.enum.length-2?m+=" or ":t<l.enum.length-1&&(m+=", ")}),m+="</div>"),m+="</span>",s(l,m)}).join("</div><div>")),d+="</div>"):d+="<div>"+s(e,a)+"</div>";return d}if(_.isObject(arguments[0])&&(e=void 0,t=arguments[0],i=arguments[1],n=arguments[2]),i=i||{},t=Helpers.resolveSchema(t),"string"==typeof t.$ref&&(e=Helpers.simpleRef(t.$ref),void 0===(t=i[e])))throw error(e+" is not defined!");"string"!=typeof e&&(e=t.title||"Inline Model"),t.definition&&(t=t.definition),"function"!=typeof n&&(n=function(e){return(e||{}).default});for(var p={},l=[],m=0,d=a(t,e);_.keys(p).length>0;)_.forEach(p,function(e,t){var i=_.indexOf(l,t)>-1;delete p[t],i||(l.push(t),d+=a(e,t))});return d};
